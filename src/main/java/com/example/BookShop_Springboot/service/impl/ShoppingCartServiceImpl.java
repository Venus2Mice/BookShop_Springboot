...
import com.example.BookShop_Springboot.dto.CartItemDto;
...
import com.example.BookShop_Springboot.repository.CartItemRepository;
import com.example.BookShop_Springboot.repository.ShoppingCartRepository;
...
public class ShoppingCartServiceImpl implements ShoppingCartService{
    ...
    @Override
    public List<CartItem> sortCartItems(Set<CartItem> cartItems) {
        List<CartItem> sortList = new ArrayList<>(cartItems);
        sortList.sort((o1, o2) -> o1.getProduct().getName().compareTo(o2.getProduct().getName()));
        return sortList;
    } 
}
